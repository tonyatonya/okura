...
<div class="container">
	...
	<div class="col-xs-9 register">
		...
		<fieldset class="featured-header orange left">
		    <legend><span class="icon icon-bubbles"></span> คุณได้รับการแนะนำจาก</legend>
		</fieldset>
		<div class="userprofile">
			<table>
				<tr>
					<td>
						<div class="user-img"><img src="images/avartar.png" alt="avartar"></div>
					</td>
					<td>
						<ul>
							<li class="user-name">MEMBERNAME	MEMBER LASTNAME</li>
							<li class="user-code">MEMBER CODE : xxxxxxxx</li>
							<li class="pos-name">ORIGIN</li>
						</ul>
		...
		<fieldset class="featured-header orange left">
		    <legend>ลงทะเบียนพันธมิตรธุรกิจ</legend>
		</fieldset>
		<p class="paragraph">
			คุณสามารถสมัครเป็นสมาชิก orkura.com ได้ง่ายๆโดยได้รับคำเชิญจากเพื่อน จากผู้ที่แนะนำท่านมาสู่ Okura โดยท่านไม่สามารถสมัครได้โดยตรงกับบริษัท โดยปราศจากคำเชิญจากเพื่อน ท่านสามารถเปลี่ยนแปลงสถานะสมาชิกผ่านทางช่องทางเปลี่ยนแปลงสถานะ เมื่อท่านสมัครเป็นสมาชิกทั่วไปแล้ว 
		</p>
		<fieldset class="featured-header orange left">
		...
		<div class="condition-box">
			...
			<h3>บัญชีการใช้บริการ บัญชีที่เกี่ยวข้อง และบัญชีจากผู้ให้บริการรายอื่นของท่าน</h3>
			<p class="paragraph">
			...
			<table style="width:94%; margin-left:auto; margin-right:auto; height: auto; margin-top: 15px;">
				<tr>
					<td style="border:none; text-align: left"><input type="checkbox" style="font-size: 15px; margin-right:10px;"> <label style="font-family: 'thaisans_neueregular'; color: #ef8b1e; font-size: 22px; font-weight: normal;">ฉันเข้าใจและยอมรับข้อตกลงในการดำเนินการนี้</label></td>
					<td style="text-align: right;"><input type="submit" class="greenbtn" value="ดำเนินการต่อ" style="margin: 0;"></td>
				</tr>
			</table>
		</div>
	</div>
